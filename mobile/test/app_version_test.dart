...
void main() {
  group('0. Verificação da Versão Efetivamente Compilada no AppConfig', () {
    test('AppConfig reflete fielmente a release 1.0.8+13', () {
  ...
  group('2. Comparação de Build Number e Resposta Real do Backend (AppConfig.shouldPromptUpdate)', () {
    ...
    // Testes usando a versão instalada padrão (1.0.8+13)
    test('instalada padrão (1.0.8+13) / remota version "1.0.8" e buildNumber 14: atualizar', () {
    ...
    test('instalada padrão (1.0.8+13) / remota version "1.0.8" e buildNumber 13: não atualizar', () {
      final shouldUpdate = AppConfig.shouldPromptUpdate(
        remoteVersion: '1.0.8',
    ...
    test('instalada padrão (1.0.8+13) / remota version "1.0.9" e buildNumber 1: atualizar', () {
      final shouldUpdate = AppConfig.shouldPromptUpdate(
        remoteVersion: '1.0.9',
        remoteBuildNumber: 1,
        downloadUrl: validUrl,
