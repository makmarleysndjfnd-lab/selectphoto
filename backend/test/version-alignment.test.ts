...
describe('ALINHAMENTO DE VERSÃO — Consistência Multi-Camadas (1.0.8+11)', { concurrency: 1 }, () => {
  ...
  it('3. backend/src/routes/app.ts define CURRENT_APP_VERSION 1.0.8 e CURRENT_BUILD_NUMBER 11', () => {
    ...
    assert.equal(bMatch[1], '11');
  });

  it('4. mobile/pubspec.yaml define versão 1.0.8+11', () => {
  ...
  it('5. mobile/lib/config/app_config.dart define appVersion 1.0.8 e buildNumber 11', () => {
