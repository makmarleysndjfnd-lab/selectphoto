...
exports.initWarrantyCron = exports.cleanOldCostPhotos = exports.checkOverdueKmRequests = exports.requestWeeklyKm = exports.checkWarranties = void 0;
                    ...
                    if (diffDays === 7 || diffDays === 0) {
                        ...
                        for (const recipient of recipients) {
                            ...
                            if (recipient.fcmToken) {
                                await (0, firebaseConfig_1.sendPushNotification)([recipient.fcmToken], title, message, { type: 'INFO', carId: car.id });
                            }
                        }
...
exports.checkWarranties = checkWarranties;
// Solicita o preenchimento do KM toda segunda-feira às 20h
const requestWeeklyKm = async () => {
    try {
            ...
            if (car.currentUser && car.currentUser.usesOwnCar === false) {
                ...
                if (!pendingReq) {
                    ...
                    if (car.currentUser.fcmToken) {
                        await (0, firebaseConfig_1.sendPushNotification)([car.currentUser.fcmToken], title, message, { type: 'KM_REQUEST', carId: car.id });
                    }
...
exports.requestWeeklyKm = requestWeeklyKm;
// Verifica se há pedidos de KM atrasados (mais de 2 dias)
const checkOverdueKmRequests = async () => {
    try {
            ...
            for (const req of pendingRequests) {
                ...
                for (const admin of admins) {
                    ...
                    if (!alreadyAlerted) {
                        ...
                        if (admin.fcmToken) {
                            await (0, firebaseConfig_1.sendPushNotification)([admin.fcmToken], title, message, { type: 'INFO' });
                        }
                    }
                }
            }
...
exports.checkOverdueKmRequests = checkOverdueKmRequests;
const cleanOldCostPhotos = async () => {
    try {
