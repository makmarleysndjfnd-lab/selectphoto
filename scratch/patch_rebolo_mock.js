...
// 2. Replace _buildStockTab contents
...
content = content.replace(/Widget _buildStockTab\(\) \{[\s\S]*?Widget _buildCityStockCard\(Map<String, dynamic> cityData\) \{/m, newBuildStockTab + '\n\n  Widget _buildCityStockCard(Map<String, dynamic> cityData) {');

// 3. Remove _buildCityStockCard
content = content.replace(/Widget _buildCityStockCard\(Map<String, dynamic> cityData\) \{[\s\S]*?Widget _buildRotasInteligentes\(\{bool isRebolo = false\}\) \{/m, 'Widget _buildRotasInteligentes({bool isRebolo = false}) {');
